...
export const CancellableNotification = ({
  ...
  return (
    <div className="bg-grey-900 py-2.5 md:py-3 px-3.5 flex w-full max-sm500:max-w-[calc(100%-40px)] sm500:w-[350px] items-center rounded-md absolute max-h-[44px] top-14 md:top-10 z-10">
