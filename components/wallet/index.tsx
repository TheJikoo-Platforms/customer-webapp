...
export default function Wallet() {
  ...
  return (
    <div className="bg-white min-h-screen md:min-h-[700px] pb-[125px] md:grid md:grid-cols-[55%,45%] md:gap-4 md:bg-transparent md:mt-6 md:px-6 max-w-[1104px] justify-center lg:grid-cols-[560px,420px] mx-auto">
      <div
        className={`${
