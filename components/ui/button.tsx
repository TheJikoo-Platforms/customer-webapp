...
const buttonVariants = cva(
  "inline-flex items-center justify-center py-4 h-auto whitespace-nowrap rounded-[9.74px] text-base font-bold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 font-dm-sans",
  {
    variants: {
      variant: {
